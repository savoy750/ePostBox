package ch.fer.epost.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(ch.fer.epost.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(ch.fer.epost.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(ch.fer.epost.application.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(ch.fer.epost.application.domain.Authority.class.getName(), jcacheConfiguration);
