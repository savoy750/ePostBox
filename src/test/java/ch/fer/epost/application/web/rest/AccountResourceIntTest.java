...
import ch.fer.epost.application.config.Constants;
import ch.fer.epost.application.EPostBoxApp;
import ch.fer.epost.application.domain.Authority;
import ch.fer.epost.application.domain.PersistentToken;
import ch.fer.epost.application.domain.User;
import ch.fer.epost.application.repository.AuthorityRepository;
import ch.fer.epost.application.repository.PersistentTokenRepository;
import ch.fer.epost.application.repository.UserRepository;
import ch.fer.epost.application.security.AuthoritiesConstants;
import ch.fer.epost.application.service.MailService;
import ch.fer.epost.application.service.dto.UserDTO;
import ch.fer.epost.application.web.rest.errors.ExceptionTranslator;
import ch.fer.epost.application.web.rest.vm.KeyAndPasswordVM;
import ch.fer.epost.application.web.rest.vm.ManagedUserVM;
import ch.fer.epost.application.service.UserService;
