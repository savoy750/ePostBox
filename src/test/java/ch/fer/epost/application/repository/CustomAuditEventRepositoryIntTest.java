...
import ch.fer.epost.application.config.audit.AuditEventConverter;
import ch.fer.epost.application.domain.PersistentAuditEvent;
...
import static ch.fer.epost.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
