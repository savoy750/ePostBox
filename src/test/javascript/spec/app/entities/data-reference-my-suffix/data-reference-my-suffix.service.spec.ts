...
describe('Service Tests', () => {
    ...
    describe('DataReferenceMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DataReferenceMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-references';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataReferenceMySuffix', () => {
