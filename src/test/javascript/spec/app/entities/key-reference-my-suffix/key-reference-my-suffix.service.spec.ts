...
describe('Service Tests', () => {
    ...
    describe('KeyReferenceMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(KeyReferenceMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/key-references';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return KeyReferenceMySuffix', () => {
